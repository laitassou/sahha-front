				...
				<div className="connect_box announce_box">
					...
					<div className="box">
						...
						<ul>
							...
							<li>
								<span>2</span> Nous vous proposon et choisir des profils adaptés, pévoir et valider un planning avec vou
							</li>
							<li>
								<span>3</span> Prévoir et valider un planning avec vous
							</li>
							<li>
								<span>4</span> Suivi des intreventions dans votre espace
							</li>
						</ul>
					</div>
				</div>
