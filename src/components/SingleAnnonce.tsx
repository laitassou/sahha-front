					...
					{intervenant.map((iv, i) => (
						<section className="">
							...
							<div className="flex gap-5">
								...
								<div className="flex flex-col w-1/2">
									<h2 className="text-2xl font-bold">Evaluer ce prestataire</h2>

									< FeedbackComponent slot_id={selected_slot_id} intervenant_id={iv.id} />
								</div>
							</div>
